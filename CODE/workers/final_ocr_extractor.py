#!/usr/bin/env python3
"""
Final Optimized OCR Text Extractor for Academic Certificates
Handles various OCR text formats with maximum accuracy
"""
...
def extract_fields(ocr_text: str) -> Dict[str, Optional[str]]:
    ...
    for line in lines:
        ...
        # Student Name extraction - improved pattern
