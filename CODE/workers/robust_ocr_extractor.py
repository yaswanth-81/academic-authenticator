#!/usr/bin/env python3
"""
Robust OCR Text Extractor for Academic Certificates
Handles various OCR text formats with improved accuracy
"""
...
def extract_fields(ocr_text: str) -> Dict[str, Optional[str]]:
    ...
    for line in lines:
        ...
        # Student Name extraction - more comprehensive patterns
        if not fields["Student Name"]:
            # Pattern 1: STUDENT NAME: [NAME]
        ...
        # University Name extraction - improved pattern
        ...
        # College Name extraction - improved pattern
        ...
        # Branch extraction - improved pattern
